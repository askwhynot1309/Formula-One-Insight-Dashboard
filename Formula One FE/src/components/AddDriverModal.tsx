...
import { Modal, Form, Input, Button, message, Select, InputNumber, DatePicker } from "antd";
...
const AddDriverModal: React.FC<{ open: boolean; onClose: () => void }> = ({ open, onClose }) => {
  ...
  return (
    <Modal open={open} onCancel={onClose} title="Add Driver" footer={null} destroyOnClose>
      <Form form={form} layout="vertical" onFinish={onFinish}>
        ...
        <Form.Item>
          <Button type="primary" htmlType="submit" block>Add Driver</Button>
        </Form.Item>
      </Form>
    </Modal>
  );
